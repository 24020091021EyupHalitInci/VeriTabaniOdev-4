    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="header">
                ...
                <a href="Crud.aspx" class="btn">Tarif Yönetimi (CRUD) ⚙️</a>
            </div>
            ...
            <div class="grid">
                <asp:Repeater ID="rptTarifler" runat="server">
                    <ItemTemplate>
                        <div class="card">
                            <img src='<%# string.IsNullOrWhiteSpace(Eval("fotograf_url").ToString()) ? "https://images.unsplash.com/photo-1495521821757-a1efb6729352?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" : Eval("fotograf_url") %>' alt="Yemek Fotoğrafı">
                            <h2><%# Eval("baslik") %></h2>
                            <p><%# KisaDetayGetir(Eval("detay").ToString()) %></p> 
                            
                            <a href='Detay.aspx?id=<%# Eval("id") %>' class="btn btn-detail">Tarifi İncele 👀</a>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
